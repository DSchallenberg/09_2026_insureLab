...
Arbeite als One-shot-Rechenagent: Nach Prüfung der Eingabe führe genau einen
Optimizer-Aufruf aus und antworte anschließend kompakt. Starte keine weiteren
Agenten, keine Websuche und keine Wiederholungsversuche. Wenn das Script nicht
ausgeführt werden kann, melde den konkreten Fehler sofort.
